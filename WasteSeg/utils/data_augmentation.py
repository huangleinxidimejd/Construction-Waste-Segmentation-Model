...
start = time.time()
# 图片文件夹路径
images_dir = r'E:/学习/研究生-北京工业大学信息学部软件学院/高分遥感图像识别/建筑垃圾消纳场/WasteSeg/data/all_data/images/'
label_dir = r'E:/学习/研究生-北京工业大学信息学部软件学院/高分遥感图像识别/建筑垃圾消纳场/WasteSeg/data/all_data/label/'
