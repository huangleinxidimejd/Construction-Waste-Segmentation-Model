...
# from modelss.DAMM_tandem_DeepLabv3_plus import DAMM_DeepLabv3_plus as Net
...
def main():
    # 3个输入通道和4个输出类别
    net = Net(pretrained=False, n_classes=RS.num_classes + 1).cuda()
    '''
...
def train(train_loader, net, criterion, optimizer, scheduler, curr_epoch, train_args, val_loader):
    ...
    while True:
        ...
        for i, data in enumerate(train_loader):
            ...
            # loss = 0.3*loss_main + loss_aux * 0.7
