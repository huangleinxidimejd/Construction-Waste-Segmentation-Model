...
# from WasteSeg.modelss.DAMM_tandem_DeepLabv3_plus_171 import DAMM_DeepLabv3_plus as Net
# from WasteSeg.modelss.DSAC_DeepLabv3_plus import DSAC_DeepLabv3_plus as Net
# from WasteSeg.modelss.Feature_fusion_DeeplabV3_plus import FCN_ASPP as Net
# from WasteSeg.modelss.RDSA_DeepLabv3_plus import RDSA_DeepLabv3_plus as Net
# from WasteSeg.modelss.traditional_DeepLabv3_plus import traditional_DeepLabv3_plus as Net
...
from WasteSeg.datasets import Waste as RS
...
args = {
    ...
    'batch_size': 1,
    'net_name': 'SDSC-UNet',
    'load_path': os.path.join(working_path, 'checkpoints', 'WasteSeg', 'SDSCUNet_191e_OA87.33_F75.38_IoU64.02.pth')
}
...
def main():
    net = Net(pretrained=False, n_classes=RS.num_classes + 1)
    # 它允许将保存的状态字典加载到模块中
