...
# 定义源文件夹和三个子文件夹的路径
src_dir = 'E:/学习/研究生-北京工业大学信息学部软件学院/高分遥感图像识别/建筑垃圾消纳场/Construction waste/Building/data/1000张标注数据集/images_tif'

new_train = 'E:/学习/研究生-北京工业大学信息学部软件学院/高分遥感图像识别/建筑垃圾消纳场/Construction waste/Building/data/train/images/'
new_val = 'E:/学习/研究生-北京工业大学信息学部软件学院/高分遥感图像识别/建筑垃圾消纳场/Construction waste/Building/data/val/images/'
